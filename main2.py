...
pycrypto = Tk()
pycrypto.title("CoinX: Crypto Portfolio")
    ...
    for i in range(0, 300):
      for coin in coins:
        if api["data"][i]["symbol"] == coin[1]:
          ...
          no_coins = Label(pycrypto, text=coin[3], bg="#F3F4F6", fg="black", font="Lato 12", borderwidth=2, relief="groove", padx="2", pady="2")
